...
ul li::before{
    ...
    width: 30px;
    height: 30px;
    background-image: url('../components/Icons/select.png');
...
input:focus {
  border: 2px solid var(--greenColor); /* Change the border style when in focus */
  outline: none; /* Remove the default outline (blue highlight) on focus, if desired */
}
form button{
    font-size: 18px;
    padding: 15px 10px;
